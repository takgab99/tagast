	...
	tinymce.EditorManager = extend(tinymce, {
		...
		triggerSave : function() {
			...
			each(this.editors, function(e) {
                // TinyMCE uses the first editor of every textfield.
                // If we are in the first editor of the given textfield, then modify it.
                // The other editors would override to the first saved value.
//                if ($.inArray(e.editorId, editors) == -1) {
//                    e.save();
//                    editors[i] = e.editorId;
//                }
//                i++;
                e.save();
                if (e.id != "adddescription" && e.id != "addbody" && e.id != "addtext") exit;
            });
		},
