...
$tblDemo = new ajaxCRUD("Item", "slider", "id", "");
?>
...
<div class="row">
    ...
    <div class="col-md-10">
        ...
        $tblDemo->showOnly("image, text, weight");

        #the table fields have prefixes; i want to give the heading titles something more meaningful
        $tblDemo->displayAs("image", "Kép");
        $tblDemo->displayAs("text", "Szöveg");
        $tblDemo->displayAs("weight", "Sorrend");

        #set the textarea height of the longer field (for editing/adding)
        #http://ajaxcrud.com/api/index.php?id=setTextareaHeight
        $tblDemo->setTextareaHeight('text', 200);
...
//        $tblDemo->omitAddField("date");
        ...
        $tblDemo->setFileUpload("image", "./../img/slider/");
...
//        $tblDemo->addValueOnInsert("date", "NOW()");
        ...
        $tblDemo->addOrderBy("ORDER BY weight ASC");
...
//        $tblDemo->formatFieldWithFunction('title', 'makeBold');
        ...
        $tblDemo->load_tinyMCE('text', 'advanced');
        ...
        function displayImage($val){
            if ($val == "") return "";
            return "<a target='_blank' href=\"./../img/slider/$val\"><img src=\"./../img/slider/$val\" width=\"90\"></a>";
        }
